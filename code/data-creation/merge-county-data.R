...
tab$migration <- (tab$movers - tab$movers.same.area) / tab$population
indices <- match(data.tab$fips, tab$fips)
data.tab[, 'migration'] <- tab[indices, 'migration'] 
data.tab[, 'migration'] <- as.numeric(data.tab[, 'migration']) * 100 # convert to a percentage
...
data.tab[, 'smoking'] <- lifetime.smoking.tab$smoking[match(data.tab$fips, lifetime.smoking.tab$fips)]
...
data.tab$colorectal_05 <- tab[indices, 'lower.95']
data.tab$colorectal_95 <- tab[indices, 'upper.95']
...
data.tab$breast_05 <- tab[indices, 'lower.95']
data.tab$breast_95 <- tab[indices, 'upper.95']
...
data.tab$prostate_05 <- tab[indices, 'lower.95']
data.tab$prostate_95 <- tab[indices, 'upper.95']
...
data.tab$melanoma_05 <- tab[indices, 'lower.95']
data.tab$melanoma_95 <- tab[indices, 'upper.95']
}
...
data.tab$lung_05 <- tab[indices, 'lower.95']
data.tab$lung_95 <- tab[indices, 'upper.95']
